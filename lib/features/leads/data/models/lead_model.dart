...
class LeadModel {
  ...
  final bool finalAmountReceived;
  final String subsidyApplyStatus;
  ...
  final String assignedToLiaisonOfficer;
  final String assignedToLiaisonOfficerName;
  final String assignedToFinanceUser;
  final String assignedToFinanceUserName;
  final String assignedToMaterialEngineer;
  final String assignedToMaterialEngineerName;
  final String assignedToElectricalEngineer;
  final String assignedToElectricalEngineerName;
  ...
  const LeadModel({
    ...
    required this.assignedToLiaisonOfficer,
    required this.assignedToLiaisonOfficerName,
    required this.assignedToFinanceUser,
    required this.assignedToFinanceUserName,
    required this.assignedToMaterialEngineer,
    required this.assignedToMaterialEngineerName,
    required this.assignedToElectricalEngineer,
    required this.assignedToElectricalEngineerName,
  ...
  factory LeadModel.fromJson(Map<String, dynamic> json) {
    ...
    return LeadModel(
      ...
      currentDepartment: _str(
        json['current_department'] ?? json['currentDepartment'],
      ),
      workflowStep: _str(json['workflow_step'] ?? json['workflowStep']),
      leadStage: _str(json['lead_stage'] ?? json['leadStage']),
      paymentType: _str(json['payment_type'] ?? json['paymentType']),
      subsidyPercentage: _str(
        json['subsidy_percentage'] ?? json['subsidyPercentage'],
      ),
      paymentAmount: _str(json['payment_amount'] ?? json['paymentAmount']),
      finalAmountReceived: _bool(
        json['final_amount_received'] ?? json['finalAmountReceived'],
      ),
      subsidyApplyStatus: _str(
        json['subsidy_apply_status'] ?? json['subsidyApplyStatus'],
      ),
      ...
      assignedToDocumentAdminName: _str(
        json['assigned_to_document_admin_name'] ??
            json['assignedToDocumentAdminName'] ??
            _nestedUserName(
              json['assignedDocumentAdmin'] ?? json['assigned_document_admin'],
            ),
      ),
      assignedToLiaisonOfficer: _str(
        json['assigned_to_liaison_officer'] ?? json['assignedToLiaisonOfficer'],
      ),
      assignedToLiaisonOfficerName: _str(
        json['assigned_to_liaison_officer_name'] ??
            json['assignedToLiaisonOfficerName'] ??
            _nestedUserName(
              json['assignedLiaisonOfficer'] ??
                  json['assigned_liaison_officer'],
            ),
      ),
      assignedToFinanceUser: _str(
        json['assigned_to_finance_user'] ?? json['assignedToFinanceUser'],
      ),
      assignedToFinanceUserName: _str(
        json['assigned_to_finance_user_name'] ??
            json['assignedToFinanceUserName'] ??
            _nestedUserName(
              json['assignedFinanceUser'] ?? json['assigned_finance_user'],
            ),
      ),
      assignedToMaterialEngineer: _str(
        json['assigned_to_material_engineer'] ??
            json['assignedToMaterialEngineer'],
      ),
      assignedToMaterialEngineerName: _str(
        json['assigned_to_material_engineer_name'] ??
            json['assignedToMaterialEngineerName'] ??
            _nestedUserName(
              json['assignedMaterialEngineer'] ??
                  json['assigned_material_engineer'],
            ),
      ),
      assignedToElectricalEngineer: _str(
        json['assigned_to_electrical_engineer'] ??
            json['assignedToElectricalEngineer'],
      ),
      assignedToElectricalEngineerName: _str(
        json['assigned_to_electrical_engineer_name'] ??
            json['assignedToElectricalEngineerName'] ??
            _nestedUserName(
              json['assignedElectricalEngineer'] ??
                  json['assigned_electrical_engineer'],
            ),
      ),
      priority: _str(json['priority']),
      notes: _str(json['notes']),
      roofPhotoStatus: _str(
        json['roof_photo_status'] ?? json['roofPhotoStatus'],
      ),
      availableShadowFreeArea: _str(
        json['available_shadow_free_area'] ?? json['availableShadowFreeArea'],
      ),
      quotationAmount: _str(
        json['quotation_amount'] ?? json['quotationAmount'],
      ),
      ...
      lastContactedAt: _str(
        json['last_contacted_at'] ?? json['lastContactedAt'],
      ),
      ...
      registrationDate: _str(
        json['registration_date'] ?? json['registrationDate'],
      ),
      registrationTime: _str(
        json['registration_time'] ?? json['registrationTime'],
      ),
      registrationImages: _stringList(
        json['registration_images'] ?? json['registrationImages'],
      ),
  ...
  bool get hasInstallationDetails {
    ...
    final spNumbers =
        d['sp_numbers'] ?? d['spNumbers'] ?? d['solar_panel_serial_numbers'];
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'final_amount_received': finalAmountReceived,
      'subsidy_apply_status': subsidyApplyStatus,
      'customer_id': customerId,
      'assigned_to': assignedTo,
      'assigned_by': assignedBy,
      'created_by': createdBy,
      'updated_by': updatedBy,
      'assigned_to_document_admin': assignedToDocumentAdmin,
      'assigned_to_document_admin_name': assignedToDocumentAdminName,
      'assigned_to_liaison_officer': assignedToLiaisonOfficer,
      'assigned_to_liaison_officer_name': assignedToLiaisonOfficerName,
      'assigned_to_finance_user': assignedToFinanceUser,
      'assigned_to_finance_user_name': assignedToFinanceUserName,
      'assigned_to_material_engineer': assignedToMaterialEngineer,
      'assigned_to_material_engineer_name': assignedToMaterialEngineerName,
      'assigned_to_electrical_engineer': assignedToElectricalEngineer,
      'assigned_to_electrical_engineer_name': assignedToElectricalEngineerName,
      'priority': priority,
      'notes': notes,
      ...
      'registration_images': registrationImages,
  ...
  LeadModel copyWith({
    ...
    String? assignedToLiaisonOfficer,
    String? assignedToLiaisonOfficerName,
    String? assignedToFinanceUser,
    String? assignedToFinanceUserName,
    String? assignedToMaterialEngineer,
    String? assignedToMaterialEngineerName,
    String? assignedToElectricalEngineer,
    String? assignedToElectricalEngineerName,
    String? priority,
    String? notes,
    ...
    return LeadModel(
      ...
      finalAmountReceived: finalAmountReceived ?? this.finalAmountReceived,
      ...
      assignedToDocumentAdminName:
          assignedToDocumentAdminName ?? this.assignedToDocumentAdminName,
      assignedToLiaisonOfficer:
          assignedToLiaisonOfficer ?? this.assignedToLiaisonOfficer,
      assignedToLiaisonOfficerName:
          assignedToLiaisonOfficerName ?? this.assignedToLiaisonOfficerName,
      assignedToFinanceUser:
          assignedToFinanceUser ?? this.assignedToFinanceUser,
      assignedToFinanceUserName:
          assignedToFinanceUserName ?? this.assignedToFinanceUserName,
      assignedToMaterialEngineer:
          assignedToMaterialEngineer ?? this.assignedToMaterialEngineer,
      assignedToMaterialEngineerName:
          assignedToMaterialEngineerName ?? this.assignedToMaterialEngineerName,
      assignedToElectricalEngineer:
          assignedToElectricalEngineer ?? this.assignedToElectricalEngineer,
      assignedToElectricalEngineerName:
          assignedToElectricalEngineerName ??
          this.assignedToElectricalEngineerName,
      ...
      registrationImages: registrationImages ?? this.registrationImages,
