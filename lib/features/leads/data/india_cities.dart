...
/// City names grouped by canonical Indian state, copied from
/// `country-state-city@3.2.1` (`City.getCitiesOfState("IN", iso)`)
/// so the app matches the web customer / lead forms.
