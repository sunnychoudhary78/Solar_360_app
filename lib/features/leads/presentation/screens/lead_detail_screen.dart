...
class _LeadDetailScreenState extends ConsumerState<LeadDetailScreen> {
  ...
  /// True after a successful Documents Submitted action,
  ...
  void _syncDocumentsSubmittedUiFromStatus(String status) {
    ...
    // Workflow reopened / still before submit.
...
''';
  ...
  Widget build(BuildContext context) {
    ...
    final showDocumentsSubmittedState =
        isDocumentAdministrator && _documentsAlreadySubmitted;
          ...
          : RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (showDocumentsSubmittedState) ...[
